...
3. **Konfigurasi Environment Variable (.env)**
    ...
    Duplikasi file `.env.example` atau buat file `.env` baru di root:
...
Proyek ini merupakan bagian dari tugas mata kuliah dan bersifat **Open Source** untuk tujuan edukasi.
**License**: MIT License.
