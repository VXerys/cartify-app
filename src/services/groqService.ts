        ...
        messages: [
          {
            ...
            **B. PRODUCT NAME (product_name)**
            ...
            - **CLEANUP**: Remove filler words ("tolong", "beliin", "aku mau", "dong", "masukin").
            ...
            **E. CONTENT VALIDATION & SAFETY (CRITICAL)**
            ...
            - **Reject**: Profanity, hate speech, sexual content, insults, or toxicity (in English or Indonesian/Slang).
            - **Reject**: Irrelevant inputs (e.g., "Apa kabar", "Jalan-jalan yuk", "Random gibberish").
            ...
            Input: "Dasar bodoh kamu" (Profanity/Insult)
            Output: {"product_name": "INVALID_CONTENT", "price": 0, "qty": 0, "category": "other"}

            Input: "Halo apa kabar sayang" (Irrelevant)
            Output: {"product_name": "INVALID_CONTENT", "price": 0, "qty": 0, "category": "other"}
            ...
            Input: "3 Pizza yang masing-masing satunya lima puluh ribu"
            Output: {"product_name": "Pizza", "price": 150000, "qty": 3, "category": "food"}
